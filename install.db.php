...
if (!$statement || $statement->execute() === false) {
  ...
  $dbh->exec('CREATE TABLE pending_actions (msgid VARCHAR(100) NOT NULL, actionid INT NOT NULL, action VARCHAR(50) NOT NULL, serialno VARCHAR(50) NOT NULL, PRIMARY KEY(msgid, actionid));');
} else {
